document.addEventListener('DOMContentLoaded', () => {
  ...
  function checkScore() {
    ...
    if(score >= 1000){
      alert('GEFELICITEERD!! je hebt alle rendieren bevrijdt je kan nu verder gaan met het brengen van cadeautjes')
      document.getElementById("pagestyle").setAttribute("/puzzel-2/index.html", sheet);
